...
if(console_logging){
	var logger = new winston.Logger({
	    transports: [ 
			...
			new (winston.transports.File)({ filename: '/data/soracom.log', maxsize: 209715200, maxFiles: 3 })
		]
	});		
}else{
	var logger = new winston.Logger({
...
console.log('              ..;;ttLLCCCCCCLLtt;;..              ');
console.log(figlet.textSync('soracom', {horizontalLayout:'default', verticalLayout:'default'}));
if(!console_logging){
